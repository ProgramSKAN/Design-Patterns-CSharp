...
namespace Strategy_Pattern_Creating_an_invoice.Business.Strategies.Invoice
{
    ...
    {
        public abstract void Generate(Order order);//override on different invoice implementations

        public string GenerateTextInvoice(Order order)//shared implementaion for all invoice strategies
        {
