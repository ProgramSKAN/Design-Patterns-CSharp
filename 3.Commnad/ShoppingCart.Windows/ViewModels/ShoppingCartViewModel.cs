...
{
    //MVVM is used when builign UI in WPF
    public class ShoppingCartViewModel : ViewModelBase
    {
        private readonly IShoppingCartRepository shoppingCartRepository;
        private readonly IProductRepository productRepository;

        public System.Windows.Input.ICommand RemoveAllFromCartCommand { get; private set; }//ICommand is inbuilt here. similar to custom ICommand .this uses CommandManager under the hood
