...
//specification should contain domain knowledhge
namespace Logic.Movies
{
    ...
    public abstract class Specification<T>
    {
        ...
        {
            Func<T, bool> predicate = ToExpression().Compile();//expression to delegate //predicate:fancy name for  function that accepts some objects and return bool
            return predicate(entity);
        }

        public abstract Expression<Func<T, bool>> ToExpression();//expression is someting we need to convert our specification to
