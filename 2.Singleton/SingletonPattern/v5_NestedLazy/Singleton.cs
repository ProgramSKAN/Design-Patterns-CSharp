namespace SingletonPattern.v5
{
    ...
    public sealed class Singleton
    {
        ...
        private class Nested
        {
            ...
            //since there are no static members on this nested class , we can prevent instantiating when referencing static member like GREETING
        }
